<template>
  <div class="login">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form">
      ...
      <el-form-item style="width:100%;">
        <el-button
          ...
          style="width:150px;
                color: #fff;
                background: rgba(80,201,197,0.84);
                 margin-left:50px;"
    ...
    <div class="el-login-footer">
      <span>中北大学 @1913040236 周帅 实验室设备借用与维护管理系统</span>
    </div>
  </div>
</template>
...
.login-form {
  ...
  //阴影颜色
  inset -20px -20px 25px hsla(0, 0%, 100%, 0.96);
  /*transition: .5s;*/
  ...
  //padding内边距 上 右 下 左
  padding: 55px 75px 5px 75px;
  .el-input {
    height: 18px;
    input {
      height: 38px;
      //输入框颜色
      background-color: rgba(240, 241, 248, 0.45);
    }
  }
  .input-icon {
    height: 39px;
